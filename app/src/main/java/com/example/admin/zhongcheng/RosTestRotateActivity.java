...
public class RosTestRotateActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rostestrotate_result);
        ...
        String content = prf.getString("rostest旋转", "");
        editText.setText(content);
        int tag=prf.getInt("tag_rostestrotate",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("rostest旋转", editText.getText().toString());
        editor.putInt("tag_rostestrotate",flag);
        editor.commit();
