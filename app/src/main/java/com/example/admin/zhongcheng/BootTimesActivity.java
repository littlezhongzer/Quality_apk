...
public class BootTimesActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bootimes_result);
        ...
        String content = prf.getString("开机时间", "");
        editText.setText(content);
        int tag=prf.getInt("tag_boottimes",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("开机时间", editText.getText().toString());
        editor.putInt("tag_boottimes",flag);
        editor.commit();
