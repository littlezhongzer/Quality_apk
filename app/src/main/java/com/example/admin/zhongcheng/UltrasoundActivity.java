...
public class UltrasoundActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ultrasound_result);
        ...
        String content = prf.getString("超声波状态", "");
        editText.setText(content);
        int tag=prf.getInt("tag_ultrasound",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("超声波状态", editText.getText().toString());
        editor.putInt("tag_ultrasound",flag);
        editor.commit();
