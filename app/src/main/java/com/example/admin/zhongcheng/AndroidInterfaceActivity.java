...
public class AndroidInterfaceActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.androidinterface_result);
        ...
        String content = prf.getString("安卓接口", "");
        editText.setText(content);
        int tag=prf.getInt("tag_androidinterface",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("安卓接口", editText.getText().toString());
        editor.putInt("tag_androidinterface",flag);
        editor.commit();
