...
public class SpeakerNormalVolumeActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.speakernormalvolume_result);
        ...
        String content = prf.getString("喇叭播放音乐", "");
        editText.setText(content);
        int tag=prf.getInt("tag_speakernormalvolume",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("喇叭播放音乐", editText.getText().toString());
        editor.putInt("tag_speakernormalvolume",flag);
        editor.commit();
