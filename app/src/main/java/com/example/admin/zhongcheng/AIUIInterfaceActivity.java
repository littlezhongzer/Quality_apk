...
public class AIUIInterfaceActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aiuiinterface_result);
        ...
        String content = prf.getString("AIUI接口", "");
        editText.setText(content);
        int tag=prf.getInt("tag_aiuiinterface",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("AIUI接口", editText.getText().toString());
        editor.putInt("tag_aiuiinterface",flag);
        editor.commit();
