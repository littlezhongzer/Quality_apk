...
public class BootUpActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bootup_result);
        ...
        String content = prf.getString("开机", "");
        editText.setText(content);
        int tag=prf.getInt("tag_bootup",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("开机", editText.getText().toString());
        editor.putInt("tag_bootup",flag);
        editor.commit();
