...
public class ROSConnectActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rosconnect_result);
        ...
        String content = prf.getString("底盘连接", "");
        editText.setText(content);
        int tag=prf.getInt("tag_rosconnect",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("底盘连接", editText.getText().toString());
        editor.putInt("tag_rosconnect",flag);
        editor.commit();
