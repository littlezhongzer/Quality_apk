...
public class EthernetSwitchActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ethernetswitch_result);
        ...
        String content = prf.getString("有线开关", "");
        editText.setText(content);
        int tag=prf.getInt("tag_ethernetswitch",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("有线开关", editText.getText().toString());
        editor.putInt("tag_ethernetswitch",flag);
        editor.commit();
