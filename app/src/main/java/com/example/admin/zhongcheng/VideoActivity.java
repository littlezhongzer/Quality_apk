...
public class VideoActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.video_result);
        ...
        String content = prf.getString("摄像", "");
        editText.setText(content);
        int tag=prf.getInt("tag_video",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    public void onClick(View view) {
        ...
        editor.putString("摄像", editText.getText().toString());
        editor.putInt("tag_video",flag);
        editor.commit();
        video = editText.getText().toString();
    }
