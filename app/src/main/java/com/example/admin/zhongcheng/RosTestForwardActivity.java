...
public class RosTestForwardActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rostestforward_result);
        ...
        String content = prf.getString("rostest前进后退", "");
        editText.setText(content);
        int tag=prf.getInt("tag_rostestforward",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("rostest前进后退", editText.getText().toString());
        editor.putInt("tag_rostestforward",flag);
        editor.commit();
