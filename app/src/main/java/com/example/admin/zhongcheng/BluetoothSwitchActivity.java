...
public class BluetoothSwitchActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bluetoothswitch_result);
        ...
        String content = prf.getString("蓝牙开关", "");
        editText.setText(content);
        int tag=prf.getInt("tag_bluetoothswitch",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("蓝牙开关", editText.getText().toString());
        editor.putInt("tag_bluetoothswitch",flag);
        editor.commit();
