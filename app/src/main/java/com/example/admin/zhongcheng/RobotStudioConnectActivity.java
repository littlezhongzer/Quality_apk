...
public class RobotStudioConnectActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.robotstudioconnect_result);
        ...
        String content = prf.getString("robotstudio连接机器人", "");
        editText.setText(content);
        int tag=prf.getInt("tag_robotstudioconnect",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("robotstudio连接机器人", editText.getText().toString());
        editor.putInt("tag_robotstudioconnect",flag);
        editor.commit();
