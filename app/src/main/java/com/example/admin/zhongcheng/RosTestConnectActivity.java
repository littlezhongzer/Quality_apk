...
public class RosTestConnectActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rostestconnect_result);
        ...
        String content = prf.getString("rostest连接底盘", "");
        editText.setText(content);
        int tag=prf.getInt("tag_rostestconnect",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("rostest连接底盘", editText.getText().toString());
        editor.putInt("tag_rostestconnect",flag);
        editor.commit();
