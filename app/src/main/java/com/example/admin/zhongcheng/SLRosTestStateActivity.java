...
public class SLRosTestStateActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slrosteststate_result);
        ...
        String content = prf.getString("SLrostest机器人状态", "");
        editText.setText(content);
        int tag=prf.getInt("tag_slrosteststate",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("SLrostest机器人状态", editText.getText().toString());
        editor.putInt("tag_slrosteststate",flag);
        editor.commit();
