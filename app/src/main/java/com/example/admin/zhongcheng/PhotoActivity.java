...
public class PhotoActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String content = prf.getString("拍照", "");
        editText.setText(content);
        int tag=prf.getInt("tag_photo",6);
        if (tag==1){
    ...
    //      PhotoActivity a=new PhotoActivity();
    //       return a;
    //  }
    ...
    public void onClick(View view) {
        ...
        photo = editText.getText().toString();
        SharedPreferences.Editor editor = getSharedPreferences("tag", MODE_PRIVATE).edit();
        editor.putString("拍照", editText.getText().toString());
        editor.putInt("tag_photo",flag);
        editor.commit();
