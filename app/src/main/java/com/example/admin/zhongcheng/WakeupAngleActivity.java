...
public class WakeupAngleActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wakeupangle_result);
        ...
        String content = prf.getString("唤醒角度", "");
        editText.setText(content);
        int tag=prf.getInt("tag_wakeupangle",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("唤醒角度", editText.getText().toString());
        editor.putInt("tag_wakeupangle",flag);
        editor.commit();
