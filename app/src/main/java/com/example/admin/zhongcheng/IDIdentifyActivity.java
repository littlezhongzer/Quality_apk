...
public class IDIdentifyActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ididentify_result);
        ...
        String content = prf.getString("身份证识别", "");
        editText.setText(content);
        int tag=prf.getInt("tag_ididentify",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("身份证识别", editText.getText().toString());
        editor.putInt("tag_ididentify",flag);
        editor.commit();
