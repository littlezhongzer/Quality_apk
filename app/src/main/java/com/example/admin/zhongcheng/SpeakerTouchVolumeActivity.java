...
public class SpeakerTouchVolumeActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.speakertouchvolume_result);
        ...
        String content = prf.getString("喇叭按键播放音", "");
        editText.setText(content);
        int tag=prf.getInt("tag_speakertouchvolume",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("喇叭按键播放音", editText.getText().toString());
        editor.putInt("tag_speakertouchvolume",flag);
        editor.commit();
