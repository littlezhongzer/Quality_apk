...
public class ShutDownActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shutdown_result);
        ...
        String content = prf.getString("关机", "");
        editText.setText(content);
        int tag=prf.getInt("tag_shutdown",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("关机", editText.getText().toString());
        editor.putInt("tag_shutdown",flag);
        editor.commit();
