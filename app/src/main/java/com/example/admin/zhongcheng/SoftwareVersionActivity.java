...
public class SoftwareVersionActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.softwareversion_result);
        ...
        String content = prf.getString("软件版本", "");
        editText.setText(content);
        int tag=prf.getInt("tag_softwareversion",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("软件版本", editText.getText().toString());
        editor.putInt("tag_softwareversion",flag);
        editor.commit();
