...
public class ScreenTouchActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.screentouch_result);
        ...
        String content = prf.getString("屏幕触摸点测试", "");
        editText.setText(content);
        int tag=prf.getInt("tag_screentouch",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("屏幕触摸点测试", editText.getText().toString());
        editor.putInt("tag_screentouch",flag);
        editor.commit();
