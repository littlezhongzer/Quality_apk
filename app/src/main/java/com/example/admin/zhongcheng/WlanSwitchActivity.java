...
public class WlanSwitchActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wlanswitch_result);
        ...
        String content = prf.getString("Wlan开关测试", "");
        editText.setText(content);
        int tag=prf.getInt("tag_wlanswitch",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("Wlan开关测试", editText.getText().toString());
        editor.putInt("tag_wlanswitch",flag);
        editor.commit();
