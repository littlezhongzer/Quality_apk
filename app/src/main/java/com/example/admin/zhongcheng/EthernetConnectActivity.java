...
public class EthernetConnectActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ethernetconnect_result);
        ...
        String content = prf.getString("有线连接", "");
        editText.setText(content);
        int tag=prf.getInt("tag_ethernetconnect",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("有线连接", editText.getText().toString());
        editor.putInt("tag_ethernetconnect",flag);
        editor.commit();
