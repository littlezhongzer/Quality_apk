...
public class FindBluetoothActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.findbluetooth_result);
        ...
        String content = prf.getString("蓝牙检测", "");
        editText.setText(content);
        int tag=prf.getInt("tag_findbluetooth",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("蓝牙检测", editText.getText().toString());
        editor.putInt("tag_findbluetooth",flag);
        editor.commit();
