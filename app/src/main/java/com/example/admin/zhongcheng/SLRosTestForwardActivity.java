...
public class SLRosTestForwardActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slrostestforward_result);
        ...
        String content = prf.getString("SLrostest前进后退", "");
        editText.setText(content);
        int tag=prf.getInt("tag_slrostestforward",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("SLrostest前进后退", editText.getText().toString());
        editor.putInt("tag_slrostestforward",flag);
        editor.commit();
