...
public class SLRosTestConnectActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slrostestconnect_result);
        ...
        String content = prf.getString("SLrostest连接底盘", "");
        editText.setText(content);
        int tag=prf.getInt("tag_slrostestconnect",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("SLrostest连接底盘", editText.getText().toString());
        editor.putInt("tag_slrostestconnect",flag);
        editor.commit();
