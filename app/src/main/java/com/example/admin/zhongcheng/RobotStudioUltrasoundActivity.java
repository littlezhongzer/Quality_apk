...
public class RobotStudioUltrasoundActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.robotstudioultrasound_result);
        ...
        String content = prf.getString("robotstudio超声波", "");
        editText.setText(content);
        int tag=prf.getInt("tag_robotstudioultrasound",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("robotstudio超声波", editText.getText().toString());
        editor.putInt("tag_robotstudioultrasound",flag);
        editor.commit();
