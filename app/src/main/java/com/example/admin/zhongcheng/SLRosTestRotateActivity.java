...
public class SLRosTestRotateActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.slrostestrotate_result);
        ...
        String content = prf.getString("SLrostest旋转", "");
        editText.setText(content);
        int tag=prf.getInt("tag_slrostestrotate",6);
        if (tag==1){
            btn_pass.setBackgroundColor(Color.GREEN);
            btn_fail.setBackgroundColor(Color.GRAY);
    ...
    wifi=editText.getText().toString();
        ...
        editor.putString("SLrostest旋转", editText.getText().toString());
        editor.putInt("tag_slrostestrotate",flag);
        editor.commit();
